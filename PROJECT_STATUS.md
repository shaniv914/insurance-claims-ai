...
**Last updated:** 2026-06-23 (Subsidence Batch 4 complete — SUBS-031 to SUBS-032; 32 cases processed — Subsidence peril complete)
**Branch:** `master`
...
All four peril case databases are now complete. EOW, Storm, Flood, and Subsidence processing is finished.
...
**Total subsidence cases processed:** 32 (SUBS-001 to SUBS-032)
**Remaining to process:** 0 — all PDFs processed
...
| 4 | SUBS-031 – SUBS-032 | DRN8130715 → DRN8561608 | **Complete** |
...
### Cases Processed: SUBS-001 to SUBS-032 (Batches 1–4 complete — Subsidence database final)
...
| SUBS-031 | DRN8130715 | UK Insurance Limited | Upheld | Yes |
| SUBS-032 | DRN8561608 | Aviva Insurance Limited | Upheld | Yes |

### Next Batch

**None — all 32 PDFs have been processed.** The Subsidence case database is complete.
Subsidence playbook authoring may begin.
