"""
Creates an empty Flood_Case_Database.xlsx with the 21-column v1 schema.

Run ONCE from the repo root:
    py scripts/create_flood_case_db.py
...
def main() -> None:
    ...
    ws = wb.active
    ws.title = "Flood Cases"

    header_font   = Font(name="Calibri", size=10, bold=True, color="FFFFFF")
    header_fill   = PatternFill(start_color="0D3D6B", end_color="0D3D6B", fill_type="solid")
    ...
    print("Ready for append_flood_v1.py")
