"""
Appends Unoccupied Property Batch 2 — UNOC-011 to UNOC-020 — to
knowledge/case-databases/Unoccupied_Property_Case_Database.xlsx.

Run AFTER append_unoccupied_property_v1.py (Batch 1 already committed).
Appends only — does not modify any existing rows.
"""
...
def main() -> None:
    ...
    if not os.path.exists(xlsx_path):
        raise FileNotFoundError(
            ...
            "Run append_unoccupied_property_v1.py first (Batch 1)."
        )
