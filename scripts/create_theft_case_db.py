"""
Creates an empty Theft_Case_Database.xlsx with the 21-column v1 schema.
Column 6 is "Entry / Theft Method" (replaces "Leak Source" in Flood/EOW/Storm
and "Movement Cause" in the Subsidence database).

Run ONCE from the repo root:
    py scripts/create_theft_case_db.py
...
def main() -> None:
    ...
    print("Ready for append_theft_v1.py")
