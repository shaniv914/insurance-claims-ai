"""
Creates an empty Roof_Damage_Case_Database.xlsx with the 21-column v1 schema.
Column 6 is "Damage Cause" (replaces "Leak Source" in Flood/EOW/Storm,
"Movement Cause" in Subsidence, "Entry / Theft Method" in Theft, and
"Unoccupied Period / Circumstance" in Unoccupied Property).

Run ONCE from the repo root:
    py scripts/create_roof_damage_case_db.py
...
def main() -> None:
    ...
    print("Ready for append_roof_damage_v1.py")
